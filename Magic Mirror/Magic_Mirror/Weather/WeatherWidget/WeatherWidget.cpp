...
WeatherWidget::WeatherWidget() {
    ...
    image = new QPixmap;
    image->load(QString::fromStdString(std::filesystem::current_path()) + "/Images/" + imageName + ".png"); //loads the image from the URL
    ...
    for(int i = 0; i < descriptions.size(); i++){
        ...
        weatherPixmap->load(QString::fromStdString(std::filesystem::current_path()) + "/Images/" + descriptionImage + ".png");
