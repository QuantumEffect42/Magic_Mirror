...
#include "../../../Magic_Mirror/Date_and_Time/AddEventWidget/AddEvent.h"
...
QT_MOC_LITERAL(1, 9, 12), // "eventCreated"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 12) // "handleButton"

    },
    "AddEvent\0eventCreated\0\0handleButton"
};
...
void AddEvent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddEvent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AddEvent::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddEvent::eventCreated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AddEvent::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_AddEvent.data,
    qt_meta_data_AddEvent,
    qt_static_metacall,
    nullptr,
    nullptr
} };
